...
class TestCertName(unittest.TestCase):
    ...
    def test_rdn_create(self):
        ...
        for ava in rdn:
            if i == 0:
                self.assertEqual(rdn[i], cn_ava)
            if i == 1:
                self.assertEqual(rdn[i], ou_ava)
    ...
    def test_name(self):
        ...
        for rdn in name:
            if i == 0:
                self.assertEqual(rdn, c_rdn)
            elif i == 1:
                self.assertEqual(rdn, st_rdn)
            elif i == 2:
                self.assertEqual(rdn, l_rdn)
            elif i == 3:
                self.assertEqual(rdn, o_rdn)
            elif i == 4:
                self.assertEqual(rdn, ou_rdn)
            elif i == 5:
